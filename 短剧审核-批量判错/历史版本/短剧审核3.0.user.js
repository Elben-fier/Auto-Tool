// ==UserScript==
// @name         Shift短剧审核-自动批量判错工具【完整修复版】
// @namespace    https://doubao.com/userscripts
// @version      3.0.0
// @description  修复单条Shift勾选死循环 + 批量错误/全剧审核自动提交
// @author       Doubao
...
(function () {
  ...
  console.log('[短剧审核脚本] 3.0完整修复版已加载');
  ...
  const renderPanel = () => {
    ...
    panel.innerHTML = `
      <div class="panel-title">短剧审核助手 3.0</div>
