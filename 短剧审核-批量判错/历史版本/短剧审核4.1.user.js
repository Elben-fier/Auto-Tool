// ==UserScript==
// @name         Shift短剧审核-自动批量判错工具【通用弹窗定位版4.2】
// @namespace    https://doubao.com/userscripts
// @version      4.2.0
// @description  彻底重写弹窗定位-不依赖CSS class,全文档扫描+祖先链分析+降级兜底+调试日志
// @author       Doubao
...
(function () {
  ...
  console.log('[短剧审核脚本] 4.2通用弹窗定位版已加载');
  ...
  const renderPanel = () => {
    ...
    panel.innerHTML = `
      <div class="panel-title">短剧审核助手 4.2</div>
